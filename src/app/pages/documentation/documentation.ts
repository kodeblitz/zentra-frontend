...
@Component({
    ...
    template: `
        <div class="card">
            ...
            <p class="text-lg mb-4">Zentra is an application built with Angular and PrimeNG. Current versions is Angular v20 with PrimeNG v20. In case CLI is not installed already, use the command below to set it up.</p>
            <pre class="app-code">
